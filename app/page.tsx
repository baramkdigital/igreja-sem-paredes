      ...
      <section className="py-20 bg-branco">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto">
            <ContactForm />
            {/* Área de doação via Pix - nova versão UX/UI */}
            <div className="mt-16 flex flex-col items-center bg-bordo/95 rounded-3xl p-10 shadow-2xl border-4 border-mostarda">
              <h3 className="text-3xl md:text-4xl font-bold text-branco mb-2 font-poppins text-center drop-shadow-lg">Seja um mantenedor desta missão</h3>
              <p className="text-lg md:text-xl text-mostarda mb-6 text-center font-medium">Sua doação nos ajuda a levar esperança e transformar vidas!</p>
              ...
              <div className="flex flex-col items-center mb-4">
                ...
                <span className="block text-xl md:text-2xl font-mono text-branco bg-bordo/80 px-4 py-2 rounded-lg select-all tracking-wide shadow-inner border border-mostarda mb-2">missaoonibus@gmail.com</span>
                <button
                  type="button"
              ...
              <p className="text-branco/80 text-center text-base mt-2">Toda oferta é um passo a mais para alcançarmos novas vidas. <span className="font-semibold text-mostarda">Obrigado por semear conosco!</span></p>
            </div>
          </div>
        </div>
      </section>
